...
//Start event functions
	...
	this.draw_contextualMenu = function draw_contextualMenu(note){
		...
		//addContextEntry(menuName,text,entryName,signal,checknum,params,imgId);
...
//Draw functions	
	this.draw_title = function draw_title(note){
		...
		if(this.father.hourFrom != 0){
			var diffHour = this.father.hourFrom - hourFrom;
			hourFrom = hourFrom + diffHour;
			hourFromFloat = hourFromFloat + parseFloat(diffHour);
		}
